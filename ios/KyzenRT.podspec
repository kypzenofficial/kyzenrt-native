...
Pod::Spec.new do |s|
  ...
  s.summary      = "KyzenRT — Universal edge AI runtime for iOS by Kypzen"
  s.homepage     = "https://github.com/kypzenofficial/kyzenrt-native"
  s.license      = package["license"]
  s.authors      = { "Kypzen" => "hello@kypzen.com" }

  s.platforms    = { :ios => "13.0", :tvos => "13.0" }
  s.source       = { :git => "https://github.com/kypzenofficial/kyzenrt-native.git", :tag => "#{s.version}" }
